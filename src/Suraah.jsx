...
function Surah() {
  return (
    <div className="main">
      ...
      <p>
        Learn very short Surah and earn Reward from Allah the Almighty.
      </p>
      <div className="surah">
      ...
      <div className="surah">
        ...
        <p>
          ...
          <br />
          Illa allatheena aamanu wa ‘amilus saali haati <br/>wa tawa saw bil haqqi <br/>
          wa tawa saw bissabr.
        </p>
        <p>
          <strong>Translation :- </strong><br/>
          ...
          <br />
          Then exalt [Him] with praise of your Lord <br/>and ask forgiveness of Him.{" "}
          <br />
      ...
      <div className="surah">
        ...
        <p>
          ...
          <br />
          Who has fed them, [saving them] from hunger and 
          <br/>
      ...
      <div className="surah">
        ...
        <p>
          ...
          <br />
          Wa la ya huddu ‘alaa ta’amil miskeen, Fa wai lul-lil mu salleem,
          <br />
        ...
        <p>
          ...
          <br/>
          Those who make show [of their deeds], And withhold [simple] assistance.
        </p>
      </div>
      <br />
      <div className="surah">
        ...
        <p>
          ...
          <br />
          Ill-lal lazeena aamanoo wa ‘amilus saalihaati;<br/> falahum ajrun ghairu mamnoon,
          <br/>
        ...
        <p>
          ...
          <br />
          Except for those who believe and do righteous deeds, <br/>for they will have a reward uninterrupted.
          <br />
      ...
      <footer className="footer">
        <h5>@Copyright(2023) Reserved by Sharique Ahmad  </h5>
        
        <a href="www.instagram.com"><img src="/images/insta.png" alt="no"></img></a>
      <a href="https://github.com/Ahmadbyte"><img src="/images/git.png" alt="no"></img></a>
      <a href="https://www.linkedin.com/in/sharique-ahmad-8229221b3/"><img src="/images/linkdin.png" alt="no"></img></a>
      </footer> 
    </div>   
  );
}
